...
const Dashboard = () => {
  ...
  return (
    <div className="relative bg-gray-100 overflow-hidden h-screen">
      <header className="fixed right-0 top-0 left-60 bg-gray-100 py-3 px-4 h-16">
      ...
      <Sidemenu data={dashboardContent} />
